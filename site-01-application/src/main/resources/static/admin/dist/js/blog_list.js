$(function () {
    $("#jqGrid").jqGrid({
        ...
        colModel: [
            ...
            {label: '添加时间', name: 'addTime', index: 'addTime', width: 90}
        ],
        height: 700,
        rowNum: 10,
        rowList: [10, 20, 50],
...
function search() {
    ...
    //提交post并刷新表格
    $("#jqGrid").jqGrid("setGridParam", {url: '/backstage/blogs/'}).trigger("reloadGrid");
}
...
function editBlog() {
    ...
    window.location.href = "/backstage/blogs/" + id;
}
