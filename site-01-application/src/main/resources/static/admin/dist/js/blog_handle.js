...
$(function () {
    blogEditor = editormd("blog-editormd", {
        ...
        imageUploadURL: "/file/markdown/upload",
            ...
            if (items && items.length > 0) {
                for (var item of items) {
                    if (item.type.startsWith("image/")) {
                        ...
                        xhr.open("POST", "/file/markdown/upload");
...
$('#confirmButton').click(function () {
    ...
    var blogTags = $('#blogTags').val().join(',');
        ...
        success: function (result) {
            ...
            if (result.code === "000") {
                ...
                swal({
                    ...
                    window.location.href = "/backstage/blogs/manage";
                })
            }
            else {
                $('#articleModal').modal('hide');
...
$('#cancelButton').click(function () {
    window.location.href = "/backstage/blogs/release";
});
